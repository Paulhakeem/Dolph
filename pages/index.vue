<template>
  <div>
    ...
    >
      <div id="home1" class="text-center pt-28 text-balance select-none mb-14 lg:pt-32 xl:pt-16">
        <h1 class="text-7xl font-black text-light stroke-white stroke-2 sm:text-3xl md:2xl lg:text-5xl xl:text-6xl">
          Premium car rental
        </h1>
        <button
