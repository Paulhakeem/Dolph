<template>
  <div>
    ...
    >
      <div id="home1" class="text-center pt-28 text-balance select-none mb-14 lg:pt-32">
        <h1 class="text-7xl font-black text-light stroke-white stroke-2 lg:text-6xl">
          Premium car rental
        </h1>
        <button
      ...
      <section id="homeSection" class="px-3 lg:pt-10">
