<template>
  <div>
        ...
        >
          ...
          >
            <a
              ...
              >Home</a
            >
            <a class="font-medium text-light hover:text-white sm:py-6" href="#"
              >About Us</a
            >
            <a class="font-medium text-light hover:text-white sm:py-6" href="#"
              >Our Fleet</a
    ...
    <footer class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
      <!-- Grid -->
      <div
        class="grid grid-cols-1 md:grid-cols-3 items-center justify-center gap-5 text-center"
      >
        <div>
          <a
            class="flex-none text-xl font-bold text-heading dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
            href="#"
            aria-label="Brand"
            >P.R.E</a
          >
