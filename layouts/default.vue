      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-20 mb-10">
        ...
        <div>
          ...
          <div class="mt-3 grid space-y-3 text-sm">
            ...
            <p>
              <a
                class="inline-flex font-bold gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                href="#"
                >8:00AM - 5:00PM</a
              >
            </p>
          ...
          <h4
            class="mt-2 text-sm font-bold text-gray-900 uppercase dark:text-gray-100"
          >
            +254-792-857-288
          </h4>
          ...
          <div class="flex items-center gap-x-3">
            ...
            >
              ...
              >
                ...
                English (US)
                <svg
                  class="hs-dropdown-open:rotate-180 flex-shrink-0 w-4 h-4 text-gray-600"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
              ...
              >
                <a
                  class="flex items-center gap-x-2 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                  href="#"
                >
                  <svg
                    class="flex-shrink-0 w-3.5 h-3.5 rounded-full"
                    xmlns="http://www.w3.org/2000/svg"
                    id="flag-icon-css-us"
                    viewBox="0 0 512 512"
                  >
